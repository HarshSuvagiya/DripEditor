...
public class GROWUP_ScaleGestureDetector {
    private static final float PRESSURE_THRESHOLD = 0.67f;
    private static final String TAG = "GROWUP_ScaleGestureDetector";
    ...
    private GROWUP_MultiTouchListener.Vector2D mCurrSpanVector = new GROWUP_MultiTouchListener.Vector2D();
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, GROWUP_ScaleGestureDetector gROWUP_ScaleGestureDetector);

        boolean onScaleBegin(View view, GROWUP_ScaleGestureDetector gROWUP_ScaleGestureDetector);

        void onScaleEnd(View view, GROWUP_ScaleGestureDetector gROWUP_ScaleGestureDetector);
    }
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        ...
        public void onScaleEnd(View view, GROWUP_ScaleGestureDetector gROWUP_ScaleGestureDetector) {
        }
    }

    public GROWUP_ScaleGestureDetector(OnScaleGestureListener onScaleGestureListener) {
    ...
    public GROWUP_MultiTouchListener.Vector2D getCurrentSpanVector() {
