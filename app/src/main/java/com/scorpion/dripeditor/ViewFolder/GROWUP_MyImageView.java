...
public class GROWUP_MyImageView extends View {
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            float unused = gROWUP_MyImageView.mScaleFactor = gROWUP_MyImageView.mScaleFactor * scaleGestureDetector.getScaleFactor();
            GROWUP_MyImageView gROWUP_MyImageView2 = GROWUP_MyImageView.this;
            float unused2 = gROWUP_MyImageView2.mScaleFactor = Math.max(0.1f, Math.min(gROWUP_MyImageView2.mScaleFactor, 10.0f));
