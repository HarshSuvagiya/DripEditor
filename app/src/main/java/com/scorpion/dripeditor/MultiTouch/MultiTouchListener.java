package com.scorpion.dripeditor.MultiTouch;
...
import static com.scorpion.dripeditor.Activity.BGchangeEditor.mCurrentView;
...
public class MultiTouchListener implements OnTouchListener {
    ...
    private class ScaleGestureListener extends SimpleOnScaleGestureListener implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public MultiTouchListener(boolean isRotateEnabled, boolean isTranslateEnabled, boolean isScaleEnabled) {
        ...
        //  this.minimumScale = StickerBtn.MIN_SCALE_SIZE;
